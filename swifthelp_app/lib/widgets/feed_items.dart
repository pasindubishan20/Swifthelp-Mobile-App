...
import 'package:swifthelp_app/widgets/price_widget.dart';
                  ...
                  child: Row(
                    children: [
                      Flexible(
                        ...
                        child: FittedBox(
                          child: TextWidget(
                            text: productModel.isPiece ? 'Day' : 'Hour',
                            color: color,
                            textSize: 20,
                            isTitle: true,
                          ),
          ...
          SizedBox(
            ...
            child: TextButton(
              onPressed: () async {
                ...
                if (_isInCart) {
                  GlobalMethods.errorDialog(subtitle: 'Service already exists in cart!', context: context);
                  return;
                }
