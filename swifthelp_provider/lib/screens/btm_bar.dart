...
import 'package:swifthelp_provider/screens/home_screen.dart';
import 'package:swifthelp_provider/screens/user.dart';
...
class _BottomBarScreenState extends State<BottomBarScreen> {
  ...
  final List<Map<String, dynamic>> _pages = [
    ...
    {'page': const DashboardScreen(), 'title': 'Categories Screen'},
